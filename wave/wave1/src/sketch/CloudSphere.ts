import P5 from "p5";
import CloudVertexShader from "../shader/material/wave.vert?raw";
import CloudFragmentShader from "../shader/material/voronoiCloud.frag?raw";
export class CloudSphere {
  private p: P5;
